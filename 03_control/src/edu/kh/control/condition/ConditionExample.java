...
public class ConditionExample { //기능 제공용 클래스
	...
	public void ex4() {
		...
		// 1,2,12월 겨울 (-15도 이하 : "한파 경보" / -12도 이하 : "한파주의보")
		//3 ~ 5월은 봄
		// 6 ~ 8 여름 (35도 이상: "폭염 경보" / 33도 이상 : "폭염 주의보") 
		// 9 ~ 11 가을
		// 1 ~ 12 사이에는 "해당하는 계절이 없다." 출력
	...
	public void ex6() { 
		...
		else if (score<0 || score >100) result = "잘못 입력하셨습니다.";
...
// 탑승 가능!!!*/
		...
		if( age <0 || age >100) {
			...
			if ( height <0 || height >250) {
				...
				} else { // 나이 o 키o //그 외 조건 생각하기 : 변수를 선언만 했을 때
					result = "탑승 가능";
				}
				//result에 계속 오류가 뜨는 건 else 구문이 없기 때문
				//값을 정하지 않아서 오류가 나는 것이다.
