...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		byte byteNumber = -128; //-128 ~ 127까지 ok
		...
		//정수 자료형 기본형 - int (short, byte 옛날코드)
		int intNumber = 2147483647;
		//자료형 변수명 대입연산자 리터럴;
		//프로그래밍에서 대입되는 데이터(값 자체)를 
		//리터럴이라는 단어로도 표현
		
		//**리터럴 : 변수에 대입되거나 작성되어지는 값 자체
		// 자료형에 따라 리터럴 표기법이 다름
		
		long longNumber = 10000000000L; //l, L 둘다 OK
		...
		float floatNumber = 1.2345F; // f, F 둘다 OK
		 ...
		 *  > 반대로 생각하면 변수에 애초에 66이라는 숫자를 저장하는 것도 ok
		 *  
		 * */
		...
		//4. 특수문자 $, _만 사용 가능 (쓰지는 않는 편)
		int $intNumber; int int_Number;
		//자바는 카멜표기법 사용 _작성 표기는 DB에서 사용
		//자바의 상수에서 사용 ex) MEMBER_NAME
		
		//5. 카멜표기법 (처음은 소문자, 후속 단어 첫글자 대문자)
		char helloWorldAppleBananaTomato;
		
		//6. 변수명은 언어를 가리지 않는다. (쓰지는 않는 편)
		int 정수1번; double 실수2번 = 3.14;
