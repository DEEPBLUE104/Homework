...
public class JavaTest {
	...
	//main method 메서드 : 자바 어플리케이션(프로그램)을 
	//					실행하기 위해 반드시 필요한 구문.
	...
	public static void main(String[] args) {
		//실행 단축키 : ctrl F11
		  ...
		  System.out.println(12 % 2); // 0 :나머지
		  
		  //"" (문자열) + 숫자 함께 작성
		  System.out.println(" 14 * 19 =" + 266);
		  System.out.println(" 14 * 19 =" + 14 * 19); //266
		  
		  
		  // 자바는 사칙연산의 우선 순위를 그대로 따른다
		  // >우선 계산을 원하면 ()괄호 사용
		  System.out.println(" 90 + 70 + 65 =" + 90 + 70 + 65); // 907065 
